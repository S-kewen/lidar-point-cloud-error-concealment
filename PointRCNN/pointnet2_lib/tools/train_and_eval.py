...
import argparse
import importlib
# python train_and_eval.py --batch_size 12 --epochs 10 --ckpt_save_interval 2 --output_dir output/carla --dataset_path /mnt/sda/PointRCNN/carla
...
parser.add_argument("--dataset_path", type=str, default='/mnt/sda/PointRCNN/data')
...
if __name__ == '__main__':
    ...
    eval_set = KittiDataset(root_dir=dataset_path, mode='EVAL', split='val', npoints=5500)
    ...
    if args.mode == 'train':
        train_set = KittiDataset(root_dir=dataset_path, mode='TRAIN', split='train')
